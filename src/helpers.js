export default {
    ...
    isBoolean(obj) {
        return obj && typeof obj === 'boolean' && (false === obj || true === obj);
    },
    cleanObjectUnset(obj, type) {
        return Object.fromEntries(Object.entries(obj).filter(([k, v]) => !this.isType(v, type)))
    },
    isString(obj) {
    ...
    objectGet(obj, path, def) {
        def = def || null;
        if (!this.isString(path)) return def;
